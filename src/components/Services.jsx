                ...
                <div className="relative">
                    <div
                        ...
                        <div className="relative z-1 max-w-[17rem] ml-auto">
                            ...
                            <p className="body-2 mb-[3rem] text-n-3">Brainwave unlocks the potential of AI-powered
                                applications</p>
                            <ul className="body-2">
                        ...
                        <Generating
                            className="absolute left-4 right-4 border-n-1/10 border lg:left-1/2 lg-right-auto lg:bottom-8 lg:-translate-x-1/2"/>
                    </div>
                    ...
                    <div className="relative z-1 grid gap-5 lg:grid-cols-2">
                        <div className="relative min-h-[39rem] border border-n-1/10 rounded-3xl overflow-hidden">
                            ...
                            <div
                                ...
                                <p className="body-2 mb-[3rem] text-n-3">Automatically enhance your photos using our AI
                                    app&apos;s photo editing feature. Try it now!</p>
                            </div>
                        ...
                        <div className="p-4 bg-n-7 rounded-3xl overflow-hidden lg:min-h-[46rem]">
                            <div className="py-12 px-4 xl:px-8">
                                ...
                                <p className="body-2 mb-[2rem] text-n-3">The world&apos;s most powerful AI photo and
                                    video art generation engine. What will you create?</p>

                                <ul className="flex items-center justify-between">
                                    {brainwaveServicesIcons.map((item, index) => (
                                        <li className={`rounded-2xl flex items-center justify-center ${index === 2 ? 'w-[3rem] h-[3rem] p-0.25 bg-conic-gradient md:w-[4.5rem] ' +
                                            'md:h-[4.5rem]' : 'flex w-10 h-10 bg-n-6 md:w-15 md:h-15'}`} key={index}>
                                            <div
