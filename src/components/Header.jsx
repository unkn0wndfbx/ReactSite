...
function Header(props) {
    ...
    return (
        <div className={`fixed top-0 left-0 w-full z-50 bg-n-8/90 border-b
        border-n-6 lg:bg-n-8/90 lg:backdrop-blur-sm ${openNavigation ? "bg-n-8" :
            ...
            <div className="flex items-center px-5 lg:px-7.5 xl:px-10 max-lg:py-4">
                    ...
                    m-auto lg:flex-row">
                        {navigation.map((item) => (
                            <a key={item.id} href={item.url} onClick={handleClick}
                               ...
                               px-6 py-6 md:py-8 lg:-mr-0.25 lg:text-xs lg:font-semibold ${item.url
                               === pathname.hash ? "z-2 lg:text-n-1" : "lg:text-n-1/50"} lg:leading-5
                ...
                <a href="#signup" className="hidden button mr-8 text-n-1/50 transition-colors
